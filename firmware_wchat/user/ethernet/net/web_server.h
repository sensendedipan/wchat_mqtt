...
#define MAX_URI_SIZE	        1460            //1460//(TX_RX_MAX_BUF_SIZE/2 - sizeof(char)*2)
...
void find_http_uri_type(uint8_t*, char*);									/* find MIME type of a file */

void make_http_response_head(unsigned char*, char, uint32_t);				/* make response header */
